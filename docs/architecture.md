# Cybersecurity CPE Tracker — Architecture

## Overview

Cybersecurity CPE Tracker is a self-hosted, Dockerised web application that automatically
imports Security Now podcast episodes as CPE entries, classifies them by
domain, and provides a browser UI for reviewing, editing, and exporting records
ready for CPE submission.
...
| `isc2_summary` | string | User-written CPE submission summary |
