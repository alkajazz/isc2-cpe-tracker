...
- **Multi-vendor CPE mode** — switch between CISSP and vendor certification views (ISACA, CompTIA, etc.) from the sidebar; per-vendor credit columns update automatically
